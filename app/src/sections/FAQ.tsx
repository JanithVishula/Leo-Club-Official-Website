...
export function FAQ() {
  ...
  const hasFaqContent = !!faqConfig.titleRegular || faqConfig.faqs.length > 0;
          ...
          <div ref={ctaRef} className="mt-16 text-center opacity-0">
            ...
            {faqConfig.ctaButtonText && (
              <a
                ...
                className="inline-flex items-center gap-2 px-8 py-4 bg-white text-blue-950 font-sans font-semibold text-sm rounded-full hover:bg-offwhite transition-colors duration-300"
              >
                {faqConfig.ctaButtonText}
